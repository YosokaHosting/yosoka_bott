...
case 'shorlink':
                                          ...
                                          break
case 'loginwhm':
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://uk.inmotion.pw:2087/`)
                                          break
case 'sc':
...
case 'linkadd':
        ...
        let sUser1 = "root";
        let sPass1 = "XXXMMMP111@@#";
        let serverName1 = "uk.inmotion.pw:2087/";
              ...
              .then((e) => {
                ...
                if (e.data?.metadata?.reason == "OK") {
                  ...
                  if (allowedPkg.length > 0) {
                    let param = "account_limit=15&bandwidth_limit=15000&diskspace_limit=15&enable_account_limit=0&enable_overselling=15&enable_overselling_bandwidth=1&enable_overselling_diskspace=1&enable_package_limit_numbers=10&enable_package_limits=15&enable_resource_limits=15";
